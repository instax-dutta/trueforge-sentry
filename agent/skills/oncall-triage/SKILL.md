...
4. If metrics are elevated, look for a cause: check recent deploys (annotations) and correlate timing windows.
5. Compute all aggregations/ratios via code execution in the sandbox, not mental math.
6. Produce a verdict: correlated cause + confidence + evidence list.
